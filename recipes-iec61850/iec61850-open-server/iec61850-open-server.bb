...
#PV = "1.0+git${SRCPV}" # TODO check if this should be included
SRCREV = "${AUTOREV}"
DEPENDS = "libiec61850"
...
# TODO see if/why this cannot be done from cmake config directly
FILES_${PN} = "/opt/iec61850_open_server/" 
